...
foreach ($appxprov in $provisioned) {
    ...
    try {
        Remove-AppxProvisionedPackage -PackageName $packagename -Online -ErrorAction Silen
    }tlyContinue
...
'@
    ...
    if ($nonAdminLoggedOn -eq $false) {
        ...
        $starturl = "https://github.com/bmataire/AP-Debloat/blob/05a9e4be506f11c3f2741fa067dd384eee1f3616/start2.bin"
...
if ($manufacturer -like "*HP*") {
    ...
    if (test-path -Path 'C:\Program Files (x86)\InstallShield Installation Information\{6468C4A5-E47E-405F-B675-A70A70983EA6}\setup.exe') {
        invoke-webrequest -uri "https://raw.githubusercontent.com/bmataire/AP-Debloat/refs/heads/main/HPConnOpt.iss" -outfile "C:\Windows\Temp\HPConnOpt.iss"
...
############################################################################################################
#                                        Remove Any other installed bloatware                              #
#                                                                                                          #
############################################################################################################
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://github.com/bmataire/AP-Debloat/blob/05a9e4be506f11c3f2741fa067dd384eee1f3616/mcafeeclean.zip'
    ...
    write-output "Downloading McAfee Removal Tool"
    # Download Source
    $URL = 'https://github.com/bmataire/AP-Debloat/blob/05a9e4be506f11c3f2741fa067dd384eee1f3616/mccleanup.zip'
...
##Download the ODT
$odturl = "https://github.com/bmataire/AP-Debloat/blob/05a9e4be506f11c3f2741fa067dd384eee1f3616/odt.exe"
